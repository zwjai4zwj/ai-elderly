...
const emergencyProcedures = {
  '噎食': {
    title: '🚨 海姆立克急救法操作流程',
    steps: [
      '【评估】观察老人：双手掐喉、面色发紫、无法说话 → 确认气道异物梗阻',
      '【呼救】立即呼叫旁人拨打120，同时展开急救',
      '【站位】站在老人身后，双臂环抱其腰部',
      '【握拳】一手握拳，拳眼顶住老人脐上两横指处',
      '【包拳】另一手包住拳头',
      '【冲击】快速向内、向上冲击腹部，反复进行',
      '【观察】每次冲击后检查口腔，异物排出则停止',
      '【后续】异物排出后安抚老人，及时送医检查',
      '⚠️ 注意：婴儿/肥胖者/孕妇手法不同；昏迷者立即心肺复苏'
    ]
  },
  '心脏骤停': {
    title: '🚨 心肺复苏（CPR）操作流程',
    steps: [
      '【判断】轻拍双肩呼唤 → 无反应；观察胸廓 → 无呼吸/仅喘息',
      '【呼救】立即呼叫旁人拨打120，取AED',
      '【胸外按压】双手交叠，掌根置于两乳头连线中点',
      '  深度：5-6cm  |  频率：100-120次/分',
      '【开放气道】仰头抬颏法，清除口腔异物',
      '【人工呼吸】口对口吹气2次，每次1秒，见胸廓起伏',
      '【循环】按压:通气 = 30:2，持续进行不中断',
      '【AED】到达后立即开机，按提示操作',
      '【指征】自主呼吸恢复、意识转清 → 停止复苏，等待急救人员',
      '⚠️ 注意：按压不中断、不犹豫、不过度通气'
    ]
  },
  '跌倒': {
    title: '🚨 老人跌倒急救处理流程',
    steps: [
      '【不要急于扶起】先观察老人意识和伤情',
      '【评估意识】呼唤老人，检查有无反应',
      '【评估伤情】询问哪里疼、能不能动，检查有无外伤出血',
      '【意识不清】立即拨打120，保持呼吸道通畅，不随意搬动',
      '【怀疑骨折】尤其髋部/脊柱，不要搬动，固定伤肢，等待急救',
      '【有出血】用干净毛巾压迫止血，抬高患肢',
      '【意识清醒、伤势轻微】协助缓慢起身，搀扶至床上休息',
      '【后续】观察24-48小时，如出现头痛、呕吐、嗜睡立即送医',
      '⚠️ 注意：疑似脊柱骨折严禁搬动、严禁坐位搬运'
    ]
  },
  '痰液窒息': {
    title: '🚨 痰液窒息急救操作流程',
    steps: [
      '【判断】突发呼吸困难、面色青紫、喉部痰鸣音、不能说话',
      '【呼救】立即呼叫旁人拨打120',
      '【体位】立即扶老人坐起或侧卧位，头偏向一侧',
      '【拍背排痰】五指并拢屈曲呈空心掌，由下向上、由外向内叩击背部',
      '【鼓励咳嗽】让老人深吸气后用力咳嗽排痰',
      '【吸痰】有设备时立即行口咽部吸痰',
      '【海姆立克】上述无效、梗阻严重时，按异物梗阻处理',
      '【观察】痰液排出后观察呼吸、面色，安抚老人',
      '【后续】送医检查，查明痰多原因，制定排痰方案',
      '⚠️ 注意：操作同时注意观察老人意识和呼吸变化'
    ]
  },
  '高烧': {
    title: '🚨 老人高热急救处理流程',
    steps: [
      '【测温确认】腋下体温≥38.5℃或口腔体温≥39℃',
      '【观察症状】有无寒战、头痛、呕吐、意识改变',
      '【物理降温】温水擦浴（颈部、腋窝、腹股沟），禁用酒精擦浴',
      '【补充水分】鼓励多饮水，防止脱水',
      '【松解衣物】减少盖被，利于散热',
      '【药物降温】遵医嘱服用退烧药，观察用药反应',
      '【监测体温】每30-60分钟测一次并记录',
      '【及时就医】持续高热不退、伴有意识障碍/抽搐/呼吸困难 → 立即送医',
      '⚠️ 注意：老年人体温调节能力差，降温不宜过快过猛'
    ]
  },
  '擦伤': {
    title: '🚨 擦伤/皮肤外伤处理流程',
    steps: [
      '【评估伤口】观察伤口深度、大小、有无异物、出血情况',
      '【冲洗伤口】生理盐水或清水冲洗伤口，冲去污物',
      '【消毒】碘伏由内向外环形消毒伤口及周围皮肤（直径≥5cm）',
      '【止血】少量出血用无菌纱布压迫止血',
      '【包扎】无菌敷料或创可贴覆盖伤口',
      '【较深伤口】伤口深、出血多、有污染 → 压迫止血后及时送医',
      '【破伤风】伤口深且污染重 → 24小时内注射破伤风抗毒素',
      '【后续观察】每日换药，观察有无红肿、渗液、化脓',
      '⚠️ 注意：禁用红药水、紫药水；酒精不宜直接用于创面'
    ]
  },
  '褥疮': {
    title: '🚨 褥疮应急处理与护理流程',
    steps: [
      '【分期评估】Ⅰ期：红斑；Ⅱ期：水疱/破溃；Ⅲ期：全层皮肤缺损；Ⅳ期：深达骨/肌肉',
      '【解除压迫】立即更换体位，避免患处继续受压',
      '【Ⅰ期处理】加强翻身（每2小时一次），局部按摩促进循环，保持皮肤干燥',
      '【Ⅱ期处理】保护水疱：小水疱自行吸收，大水疱无菌抽吸，无菌敷料覆盖',
      '【Ⅲ/Ⅳ期】及时就医，专业换药治疗',
      '【减压措施】使用气垫床、减压垫、软枕架空受压部位',
      '【营养支持】增加蛋白质、维生素摄入，促进愈合',
      '【皮肤护理】保持床单平整干燥，避免摩擦和剪切力',
      '⚠️ 注意：Ⅰ期禁止按摩（可能加重组织损伤）；严禁使用橡皮圈'
    ]
  },
  '走失': {
    title: '🚨 老人走失应急处理流程',
    steps: [
      '【立即报告】发现走失第一时间通知家属和机构负责人',
      '【调取监控】查看走失时间、行走方向、衣着特征',
      '【组织寻找】安排熟悉老人的工作人员分头寻找',
      '【重点区域】老人常去的地方、旧居、车站、公园、河边',
      '【联系警方】超过2小时未找到 → 立即拨打110报警',
      '【联系家属】第一时间通知家属，询问可能去向',
      '【利用资源】微信朋友圈、社区群发布寻人启事',
      '【防范措施】佩戴防走失手环、口袋放置身份卡片',
      '⚠️ 注意：阿尔茨海默症老人走失风险最高，需重点防范，夜间加强巡视'
    ]
  }
}

// 获取当前急救类型的规范流程
const currentEmergencyProcedure = computed(() => {
  const em = caseProfile.value.customEmergency || caseProfile.value.emergency || ''
  return emergencyProcedures[em] || null
})
